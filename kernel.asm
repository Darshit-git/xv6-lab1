...
801003c4:	e8 e7 02 00 00       	call   801006b0 <cprintf>
  cprintf("\n");
801003c9:	c7 04 24 d7 80 10 80 	movl   $0x801080d7,(%esp)
...
801041f3:	68 d7 80 10 80       	push   $0x801080d7
...
8010588c:	78 5f                	js     801058ed <sys_wolfie+0x7d>
   return -1;
   }
...
8010589a:	e8 01 f1 ff ff       	call   801049a0 <argptr>
8010589f:	83 c4 10             	add    $0x10,%esp
801058a2:	85 c0                	test   %eax,%eax
801058a4:	78 47                	js     801058ed <sys_wolfie+0x7d>
   return -1;
   }
...
801058ba:	75 f4                	jne    801058b0 <sys_wolfie+0x40>
   ...
   if(artsize > size){
801058bc:	39 55 f4             	cmp    %edx,-0xc(%ebp)
...
801058d0:	0f b6 98 e0 78 10 80 	movzbl -0x7fef8720(%eax),%ebx
      ((char*)buf)[i] = art[i];
801058d7:	8b 75 f0             	mov    -0x10(%ebp),%esi
...
8010596e:	00 00 ef 
  initlock(&tickslock, "time");
80105971:	68 f9 7e 10 80       	push   $0x80107ef9
...
801059f4:	3e ff 24 85 a0 7f 10 	notrack jmp *-0x7fef8060(,%eax,4)
801059fb:	80 
    lapiceoi();
    break;
...
80105a51:	68 5c 7f 10 80       	push   $0x80107f5c
...
80105b6c:	68 04 7f 10 80       	push   $0x80107f04
...
80105c08:	68 28 7f 10 80       	push   $0x80107f28
80105c0d:	e8 9e aa ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105c12:	83 c4 14             	add    $0x14,%esp
80105c15:	68 fe 7e 10 80       	push   $0x80107efe
...
80105d13:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80105d18:	bb 20 80 10 80       	mov    $0x80108020,%ebx
  ioapicenable(IRQ_COM1, 0);
...
8010691d:	68 28 80 10 80       	push   $0x80108028
...
80106c0f:	68 6d 80 10 80       	push   $0x8010806d
...
80106d79:	68 a5 80 10 80       	push   $0x801080a5
...
80106ddb:	68 bd 80 10 80       	push   $0x801080bd
...
80106ebc:	68 d9 80 10 80       	push   $0x801080d9
...
80106f93:	68 ea 80 10 80       	push   $0x801080ea
...
80107079:	68 0e 81 10 80       	push   $0x8010810e
8010707e:	e8 0d 93 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80107083:	83 ec 0c             	sub    $0xc,%esp
80107086:	68 f4 80 10 80       	push   $0x801080f4
