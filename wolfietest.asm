...
_wolfietest:     file format elf32-i386
...
int main(void)
{
 ...
 void *buf = malloc(3000);
  15:	68 b8 0b 00 00       	push   $0xbb8
  1a:	e8 51 06 00 00       	call   670 <malloc>
 int x = wolfie(buf,3000);
  1f:	5a                   	pop    %edx
  20:	59                   	pop    %ecx
  21:	68 b8 0b 00 00       	push   $0xbb8
  26:	50                   	push   %eax
  27:	e8 27 03 00 00       	call   353 <wolfie>
